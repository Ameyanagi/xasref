...
from larch.xafs import energy_align, pre_edge, autobk, xftf
from larch.io import merge_groups, read_athena, read_ascii
...
def shift_save_group(group: Group, ref_e0: float, filename: str | None = None):
    group.e0 = ref_e0
    pre_edge(group)
...
def generate_foil_dat():
    for foil in foil_dict:
        ...
        save_dir = os.path.dirname(foil["path"])
        shift_save_group(
            group,
            foil["e0"],
